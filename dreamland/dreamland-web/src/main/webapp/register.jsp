...
<head>
	<meta charset="UTF-8">
	<title>注册页面</title>
	<meta name="keywords" content="cjw的个人博客">
	<meta name="content" content="cjw的个人博客">
...
<div class="zhuce_body" >
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
        	<div class="bj_bai" id="regist-left" style="height: 408px">
            <h3>欢迎注册</h3>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《cjw的个人博客用户协议》</span></a></span>
                    <br/>
...
<script type="text/javascript">
        ...
        if(code == ""){
            ...
            $.ajax({
                ...
                success: function (data) {//success指的是请求并成功返回信息；data是返回的内容。
                    var val = data['message'];//后台返回的数据是hashmap（key-value）,以“message”为键，“success”为值存入 map 集合。
                    if (val == "success") {
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受cjw的个人博客用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
